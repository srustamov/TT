...
return array(
    ...
    // 'Email' => TT\Facades\Email::class ,
    // 'File' => TT\Facades\File::class ,
    // 'Hash' => TT\Facades\Hash::class ,
    // 'Html' => TT\Facades\Html::class ,
    // 'Http' => TT\Facades\Http::class ,
    // 'Language' => TT\Facades\Language::class ,
    // 'OpenSsl' => TT\Facades\OpenSsl::class ,
    // 'Jwt' => TT\Facades\Jwt::class,
    // 'Redirect' => TT\Facades\Redirect::class ,
    ...
    // 'Validator' => TT\Facades\Validator::class ,
    // 'View' => TT\Facades\View::class ,
